...
public final class AddAnimationEditCommand extends SlideRegionEditCommand<ObservableSlide<?>> implements EditCommand {
	...
	public AddAnimationEditCommand(SlideAnimation animation, ObservableSlide<?> slide, ObjectProperty<ObservableSlideRegion<?>> selection, ListView<SlideAnimation> list) {
