 ...
 * @since 1.0.0
 */
public class StillDisplayPanel extends JPanel implements DisplayRenderer {
	/** The version id */
	...
	/* (non-Javadoc)
	 * @see org.praisenter.display.ui.DisplayPanel#send(org.praisenter.display.Display, org.praisenter.transitions.TransitionAnimator)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.praisenter.display.ui.DisplayPanel#clear(org.praisenter.transitions.TransitionAnimator)
	 */
	@Override
