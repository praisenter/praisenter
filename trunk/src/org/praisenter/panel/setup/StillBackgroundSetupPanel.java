 ...
 * @since 1.0.0
 */
public class StillBackgroundSetupPanel extends JPanel implements ActionListener, ItemListener, ChangeListener {
	/** The version id */
	private static final long serialVersionUID = -8394312426259802361L;

	/** The class logger */
	private static final Logger LOGGER = Logger.getLogger(StillBackgroundSetupPanel.class);
