 ...
 *
 */
public class DecodeAndPlayVideo extends Application {

  /**
   * Opens a file, and plays the video from it on a screen at the right rate.
   * @param filename The file or URL to play.
   */
  private static void playVideo(String filename, ImageView window) throws InterruptedException, IOException {
    /*
  ...
  private static BufferedImage displayVideoAtCorrectTime(long streamStartTime,
      ...
      BufferedImage image, final ImageView window, long systemStartTime,
    ...
    Platform.runLater(new Runnable() {
		@Override
		public void run() {
			System.out.println("on fx thread " + img.getType() + " == " + BufferedImage.TYPE_INT_ARGB + "?");
			window.setImage(SwingFXUtils.toFXImage(img, null));
		}
  ...
  @Override
	public void start(Stage primaryStage) throws Exception {
      ...
      MediaPlayer mp = new MediaPlayer(new javafx.scene.media.Media(new File("D:\\Personal\\Praisenter\\testmedialibrary\\big_buck_bunny_1080p_H264_AAC_25fps_7200K_short.MP4").toURI().toString()));
      MediaView mv = new MediaView(mp);
      mv.setFitHeight(800);
      mv.setFitHeight(600);
      
      FadeTransition fadeIn = new FadeTransition();
      fadeIn.setDuration(Duration.millis(5000));
...
//      mp.setMute(arg0);
//      mp.setVolume(value);
//      mp.setStartTime(value);
//      mp.setStopTime(value);
      ...
      stack.setBackground(new Background(new BackgroundFill(Color.TRANSPARENT, null, null)));
      stack.getChildren().addAll(mv, txt);
//      root.setCenter(img);
...
//		public void run() {
//			try {
//				playVideo("D:\\Personal\\Praisenter\\testmedialibrary\\trailer_1080p.ogg", img);
