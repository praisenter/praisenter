...
public class BackgroundRibbonTab extends EditorRibbonTab {
	...
	public BackgroundRibbonTab(PraisenterContext context) {
		super("Background");
		...
		this.pkrImage = new MediaPicker(context, MediaType.IMAGE);
		this.pkrImage.setValue(null);
		this.pkrImage.managedProperty().bind(pkrImage.visibleProperty());
		
		this.pkrVideo = new MediaPicker(context, MediaType.VIDEO);
