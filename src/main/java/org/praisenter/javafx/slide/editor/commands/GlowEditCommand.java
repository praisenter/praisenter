...
public final class GlowEditCommand extends SlideRegionValueChangedEditCommand<SlideShadow, ObservableSlideComponent<?>> implements EditCommand {
	private final Node focusNode;
	private final ActionEditCommand actions;
	
	public GlowEditCommand(SlideShadow oldValue, SlideShadow newValue, ObservableSlideComponent<?> region, ObjectProperty<ObservableSlideRegion<?>> selection, Node focusNode, ActionEditCommand actions) {
