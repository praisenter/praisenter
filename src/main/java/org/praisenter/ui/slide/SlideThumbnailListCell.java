...
final class SlideThumbnailListCell extends ListCell<Slide> {
	private static final Image TRANSPARENT_PATTERN = new Image(SlideThumbnailListCell.class.getResourceAsStream("/org/praisenter/images/transparent.png"));
	
	private final ImageView graphic;
	private final Pane pane;
	
	public SlideThumbnailListCell() {	
		this.pane = new Pane();
