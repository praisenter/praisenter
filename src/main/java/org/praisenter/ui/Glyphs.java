...
//	public static final Glyph ADD = FONT_AWESOME.create(FontAwesome.Glyph.PLUS).color(Color.LIMEGREEN);
	...
	public static final Glyph SAVE = FONT_AWESOME.create(FontAwesome.Glyph.SAVE);
	public static final Glyph RENAME = FONT_AWESOME.create(FontAwesome.Glyph.TERMINAL);
	public static final Glyph DELETE = FONT_AWESOME.create(FontAwesome.Glyph.MINUS);
	public static final Glyph COPY = FONT_AWESOME.create(FontAwesome.Glyph.COPY);
	public static final Glyph CUT = FONT_AWESOME.create(FontAwesome.Glyph.CUT);
	public static final Glyph PASTE = FONT_AWESOME.create(FontAwesome.Glyph.PASTE);
	public static final Glyph UNDO = OPEN_ICONIC.create(OpenIconic.Glyph.ACTION_UNDO);
	public static final Glyph REDO = OPEN_ICONIC.create(OpenIconic.Glyph.ACTION_REDO);
	
//	public static final Glyph REMOVE = FONT_AWESOME.create(FontAwesome.Glyph.MINUS).color(Color.RED);

	public static final Glyph EXPORT = FONT_AWESOME.create(FontAwesome.Glyph.UPLOAD);
	public static final Glyph IMPORT = FONT_AWESOME.create(FontAwesome.Glyph.DOWNLOAD);
	
	public static final Glyph SORT_ASC = FONT_AWESOME.create(FontAwesome.Glyph.SORT_ALPHA_ASC);
	public static final Glyph SORT_DESC = FONT_AWESOME.create(FontAwesome.Glyph.SORT_ALPHA_DESC);
	
	public static final Glyph RENUMBER = FONT_AWESOME.create(FontAwesome.Glyph.SORT_NUMERIC_ASC);
	public static final Glyph REORDER = FONT_AWESOME.create(FontAwesome.Glyph.SORT_AMOUNT_ASC);
	
	public static final Glyph SELECT_ALL = FONT_AWESOME.create(FontAwesome.Glyph.CIRCLE);
	public static final Glyph SELECT_NONE = FONT_AWESOME.create(FontAwesome.Glyph.CIRCLE_ALT);
...
//	
//	/** Menu delete icon */
//	public static final Glyph MENU_DELETE = FONT_AWESOME.create(FontAwesome.Glyph.MINUS);
//	
//	/** Menu copy icon */
