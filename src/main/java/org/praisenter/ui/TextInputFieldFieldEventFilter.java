...
public final class TextInputFieldFieldEventFilter implements EventHandler<KeyEvent> {
	private final Node node;
	
	public static void applyTextInputFieldEventFilter(Node node) {
		new TextInputFieldFieldEventFilter(node);
	}
	 ...
	 */
	private TextInputFieldFieldEventFilter(Node node) {
		this.node = node;
