...
public final class CommandLine {
	 ...
	 */
	public static final String execute_nolongerworksinjava16(List<String> command) throws IOException, InterruptedException, MediaToolExecutionException {
		// run the command
	...
	public static final String execute(List<String> command) throws IOException, InterruptedException, MediaToolExecutionException {
		org.apache.commons.exec.CommandLine cmdLine = org.apache.commons.exec.CommandLine.parse(String.join(" ", command));
