...
// TODO probably remove, was going to use to based on the following SO post:
// http://stackoverflow.com/questions/2252028/jaxb-how-to-avoid-repeated-namespace-definition-for-xmlnsxsi
public class XmlNamespaceWriter implements XMLStreamWriter {

    private final XMLStreamWriter writer;

    public XmlNamespaceWriter(XMLStreamWriter writer) {
        this.writer = writer;
    }
